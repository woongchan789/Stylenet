...
def main():
    ...
    # REVISE: best_model이었던 inception_v3 사용하여 inference
    encoder.load_state_dict(torch.load('pretrained_models/inception_v3/encoder-10.pkl'))
    decoder.load_state_dict(torch.load('pretrained_models/inception_v3/decoder-10.pkl'))
